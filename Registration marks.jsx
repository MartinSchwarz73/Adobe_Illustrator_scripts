...
//	doc.defaultFillColor = whiteColor;
	...
	doc.defaultStroked = false;
	var vnejsi = mikrobod.pathItems.ellipse(
			(doc.artboards[0].artboardRect[1] + doc.artboards[0].artboardRect[3])/2 + vnejsiPrumer/2, 
			doc.artboards[0].artboardRect[0] + vzdOdKraje - vnejsiPrumer/2, 
			vnejsiPrumer, 
			vnejsiPrumer, 
			false);
	var vnitrni = mikrobod.pathItems.ellipse(
			(doc.artboards[0].artboardRect[1] + doc.artboards[0].artboardRect[3])/2 + vnitrniPrumer/2, 
			doc.artboards[0].artboardRect[0] + vzdOdKraje - vnitrniPrumer/2, 
			vnitrniPrumer, 
			vnitrniPrumer, 
			true);
	vnejsi.filled = true;
